		...
		<div class="col-md-6">
				...
				<form id="form_config_company" action="{{ route('config_update') }}" class="form-horizontal" method="POST" enctype="multipart/form-data">
					<div class="box-body">
						<div class="form-group">
							...
							<div class="col-sm-3">
								<input type="text" class="form-control" id="config_company_short_name" name="config[company_short_name]" placeholder="Company short name" value="{{ $config->getConfigValueByKey('company_short_name') }}">
							</div>
						</div>
						<div class="form-group">
							<label for="config_company_website" class="col-sm-2 control-label">網址</label>
							<div class="col-sm-10">
								<input type="text" class="form-control" id="config_company_website" name="config[company_website]" placeholder="Website" value="{{ $config->getConfigValueByKey('company_website') }}">
							</div>
						</div>
						<div class="form-group">
							<label for="config_company_logo" class="col-sm-2 control-label">LOGO</label>
							<div class="col-sm-10">
								<input id="config_company_logo" name="config[company_logo]" class="file" type="file" value="{{ $config->getConfigValueByKey('company_logo') }}">
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-10">
								<img src = ".\dist\img\{{ $config->getConfigValueByKey('company_logo') }}">
							</div>
                            @endif
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control" id="config_company_domain" name="config[company_domain]" placeholder="Wabow.com" value="{{ $config->getConfigValueByKey('company_domain') }}">
							</div>
						</div>
					</div>
					<!-- /.box-body -->
			...
			<div class="box box-success">
				...
				<div class="box-body">
					...
					<div class="col-sm-7">
						<input type="email" class="form-control" id="config_smtp_host" name="config[config_smtp_host]" placeholder="ex: smtp.gmail.com" value="{{ $config->getConfigValueByKey('config_smtp_host') }}">
					</div>

					<label for="config_smtp_port" class="col-sm-1 control-label">Port</label>
					<div class="col-sm-2">
						<input type="text" class="form-control" id="config_smtp_port" name="config[smtp_port]" placeholder="465" value="{{ $config->getConfigValueByKey('smtp_port') }}">
					</div>
					</div>
					<div class="form-group">
					...
					<div class="col-sm-4">
						<input type="text" class="form-control" id="config_smtp_username" name="config[smtp_username]" placeholder="ex: test-leave@gmail.com" value="{{ $config->getConfigValueByKey('smtp_username') }}">
					</div>

					<label for="config_smtp_password" class="col-sm-2 control-label">Password</label>

					<div class="col-sm-4">
						<input type="password" class="form-control" id="config_smtp_password" name="config[smtp_password]" placeholder="請輸入密碼" value="{{ $config->getConfigValueByKey('smtp_password') }}">
					</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<label>
								<input type="radio" name="config[smtp_auth]" class="flat-red" value="true" @if ( $config->getConfigValueByKey('smtp_auth')  == 'true') checked="checked" @endif >
								是
							</label>&emsp;
							<label>
								<input type="radio" name="config[smtp_auth]" class="flat-red" value="false" @if ( $config->getConfigValueByKey('smtp_auth')  == 'false') checked="checked" @endif>
								否
							</label>&emsp;
						</div>
					</div>
					...
					<div class="col-sm-4">
						<input type="text" class="form-control" id="config_smtp_from" name="config[smtp_from]" placeholder="hello" value="{{ $config->getConfigValueByKey('smtp_from') }}">
					</div>

					<label for="config_smtp_display" class="col-sm-2 control-label">Display</label>

					<div class="col-sm-4">
						<input type="text" class="form-control" id="config_smtp_display" name="config[smtp_display]" placeholder="請假機器" value="{{ $config->getConfigValueByKey('smtp_display') }}">
					</div>
					</div>
				</div>
				<!-- /.box-body -->
				...
				<form id="form_config_google" action="{{ route('config_update') }}" class="form-horizontal" method="POST" enctype="multipart/form-data">
					<div class="box-body">
						<div class="form-group">
							...
							<div class="col-sm-9">
								<label>
									<input type="radio" name="config[google_status]" class="flat-red" value="true" @if ($config->getConfigValueByKey('google_status') == 'true' ) checked="checked" @endif>
									是
								</label>&emsp;
								<label>
									<input type="radio" name="config[google_status]" class="flat-red" value="false" @if ($config->getConfigValueByKey('google_status') == 'false' ) checked="checked" @endif>
									否
								</label>&emsp;
							</div>
						</div>
				...
				<form id="form_config_slack" action="{{ route('config_update') }}" class="form-horizontal" method="POST" enctype="multipart/form-data">
					<div class="box-body">
						<div class="form-group">
							...
							<div class="col-sm-10">
								<label>
									<input type="radio" name="config[slack_status]" class="flat-red" value="true" @if ($config->getConfigValueByKey('slack_status') == 'true') checked="checked" @endif>
									是
								</label>&emsp;
								<label>
									<input type="radio" name="config[slack_status]" class="flat-red" value="false" @if ($config->getConfigValueByKey('slack_status')  == 'false') checked="checked" @endif>
									否
								</label>&emsp;
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-5">
								<input type="email" class="form-control" id="config_slack_token" name="config[slack_token]" placeholder="API Token" value="{{ $config->getConfigValueByKey('slack_token') }}">
							</div>

							<label for="config_slack_public_channel" class="col-sm-2 control-label">廣播頻道</label>
							<div class="col-sm-3">
								<input type="text" class="form-control" id="config_slack_public_channel" name="config[slack_public_channel]" placeholder="指定通知頻道" value="{{ $config->getConfigValueByKey('slack_public_channel') }}">
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control" id="config_slack_botname" name="config[slack_botname]" placeholder="機器人代號" value="{{ $config->getConfigValueByKey('slack_botname') }}">
							</div>
						</div>
					</div>
					<!-- /.box-body -->
