          ...
          <div class="row">
            <div class="col-sm-12">
              <table class="table table-bordered table-striped table-hover">
                  <thead>
                    <tr>
                      <th width="14%"><a href="javascript:void(0)" class="sort" sortname="tag_id">狀態</a></th>
                  ...
                  <tr class='clickable-row' data-href="leave_manager_view.html">
                    <td>
                      ...
                      @if ($value->tag_id == 2 || $value->tag_id == 3)
                        <a href="{{ route('leaves_my_delete', [ 'id' => $value->id ]) }}"><button type="button" class="btn btn-danger">
