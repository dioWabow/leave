          ...
          <div class="pull-right">
            <label>
              ...
              <select id="search_tag_id" name="search[tag_id]" class="form-control">
                ...
                <option value="8" @if (count($search)>0 && $search['tag_id'] == '8') selected="selected" @endif>{{ WebHelper::getLeaveTagsLabelForHistory(8) }}</option>
                <option value="9" @if (count($search)>0 && $search['tag_id'] == '9') selected="selected" @endif>{{ WebHelper::getLeaveTagsLabelForHistory(9) }}</option>
              </select>
            </label>
            &nbsp;
            <label>
