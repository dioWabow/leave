...
<body class="hold-transition login-page">
  ...
  <div class="login-logo">
    <a href="index.html"><img src="{{route('root_path')}}{{$config->getConfigValueByKey('company_logo')}}" width="50"> <b>{{$config_allpage->getConfigValueByKey('company_short_name')}}</b>請假系統</a>
  </div>
