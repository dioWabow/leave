...
<head>
  <meta charset="utf-8">
  <title>{{$config_allpage->getConfigValueByKey('company_short_name')}}請假系統</title>
...
<body class="hold-transition login-page">
  ...
  <div class="login-logo">
    <a href="index.html"><img src="{{route('root_path')}}{{$config_allpage->getConfigValueByKey('company_logo')}}" width="50"> <b>{{$config_allpage->getConfigValueByKey('company_short_name')}}</b>請假系統</a>
  </div>
