...
<body class="hold-transition login-page">
  ...
  <div class="login-logo">
    <a href="index.html"><img src="{{ UrlHelper::getCompanyLogoUrl(ConfigHelper::getConfigValueByKey('company_logo') )}}" width="50"> <b>{{ConfigHelper::getConfigValueByKey('company_short_name')}}</b>請假系統</a>
  </div>
