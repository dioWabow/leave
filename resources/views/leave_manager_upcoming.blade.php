      ...
      <table class="table table-bordered table-striped table-hover"  data-toggle-selector=".footable-toggle" data-show-toggle="false">
        <thead>
          <tr>
            ...
            <th width="30%" data-breakpoints="xs sm"><a href="javascript:void(0)" class="sort" sortname="reason">原因</a></th>
            <th width="16%" data-breakpoints="xs sm">代理人</a></th>
            <th width="5%"><a href="javascript:void(0)" class="sort" sortname="hours">時數(HR)</a></th>
